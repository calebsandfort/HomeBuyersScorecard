...
export class HomeBuyersScorecardService {
  ...
  setCurrentUser(forceRefresh: boolean) {
    ...
    if(typeof(deviceId) == "undefined") deviceId = "95f85a94316023f7";
  ...
  createUser(deviceId: string) {
    var that = this;
    var userType = this._manager.metadataStore.getEntityType("HomeBuyersScorecardUser");
    ...
    user.DefaultCity = "";
    user.DefaultState = "None";
    user.DefaultStateInt = 0;

    var userEntity = this._manager.createEntity("HomeBuyersScorecardUser", user);
